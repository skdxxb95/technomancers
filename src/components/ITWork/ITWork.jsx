      ...
      <div className='itwork'>
        <div className="itwork-content">
          ...
          <div className='itwork-video'>
            ...
            <i><small>Unfortunately there were some troubles with David's audio, though</small></i>
          ...
          <div className='itwork-results'>
            ...
            <p>
              As a UNIX DevOps specialist, David is skilled in both programming and systems administration. This means that he is responsible for a wide range of tasks in his work, including writing code for new features or testing infrastructure, as well as doing systems administration using Infrastructure as a Service. Programming involves creating and implementing code for software applications or other computer-based systems. This work requires a strong understanding of programming languages and the ability to design and troubleshoot code. Systems administration involves managing and maintaining computer systems, including hardware and software, to ensure that they are running smoothly and efficiently. This work can involve tasks such as installing and configuring systems, monitoring performance, and troubleshooting issues. In his role, David has also been responsible for project management tasks.
            </p><br></br>
            <p>
              Depending on the specific project or company he is working for, David's work may be based in an office or remotely, such as from home. Many IT professionals, including David himself, are able to work remotely thanks to the use of video chat and the ability to access systems remotely. This allows them to be flexible in their work location and schedule, as long as they have an internet connection and proper network setup. According to David, he spends most of his time working on programming and systems administration tasks and may also be involved in project management and communication with team members and clients.
            </p><br></br>
            <p>
              As an IT professional, David interacts with a variety of people in his work. This includes his bosses, the CEO and COO, who he works closely with on projects and in the overall management of his company. He also interacts with external contractors, who may be brought in to work on specific parts of a project. In his current role as the software developer for a company that provides data intelligence services, David also interacts with clients, such as Melbourne Water, who use his company's services. In addition to working with these individuals, David also collaborates with other IT professionals on projects and may interact with investors or the general public through his work. Strong communication skills and the ability to work effectively with a range of people are important qualities for an IT professional like himself.
            </p><br></br>
            <p>
              One of the most challenging aspects of David's position as an IT professional is understanding the real priorities and communicating effectively with non-technical people about what they want and what is possible. This requires strong communication skills and the ability to translate technical concepts to those who may not have a background in IT. It can be difficult to find a common understanding and ensure that projects are successful, especially when working with people who have different levels of technical knowledge. David also faces the challenge of staying up to date with the constantly changing technology landscape, which can be a challenge given the rapid pace of innovation in the field.
            </p><br></br>
            <p>
              In this interview, we learned about the work of IT professional David, who is skilled in both programming and systems administration. He works on a variety of projects, including building network camera solutions and running monitoring systems, and spends most of his time writing code for new features or testing infrastructure, as well as doing systems administration using Infrastructure as a Service. Interacting with a wide range of people in his work, including his bosses, external contractors, and clients, had given David strong communication skills and the ability to work effectively with a variety of individuals. One of the most challenging aspects of his position is understanding the real priorities and communicating effectively with non-technical people about what they want and what is possible. He also faces the challenge of staying up to date with the constantly changing technology landscape. Overall, David's work involves a combination of programming, systems administration, and project management, and he works with a range of people in the IT industry and beyond.
            </p>
          </div>
          <div className='itwork-transcript'>
            <h2>Transcript of Interview</h2>
            <i><small>(DG - David Goh, SB - Samuel Bruce, AH - Ally Harper)</small></i>
            <br></br>
            <p>00:08</p>
            ...
            <br></br>
            <p>04:41</p>
            <p> AH: Yeah, we’ve been learning a little bit about the cloud. So who else do you interact with at work? Other IT professionals, clients, investors?  </p>
            <br></br>
            <p>05:17</p>
