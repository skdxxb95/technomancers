      ...
      <div className='teamprofile'>
        <div className='heading'>
          ...
          <div className="teamprofile-content">
            ...
            <br></br><br></br>
            I am involved in some environmental projects including Habitat 141 with Greening Australia which aims to create a wildlife corridor from the River Murray to the coast. Interested in all things recyclable, reusable and sustainable, and renewable energies.
            </p>
            {/*------ THIS IS WHERE YOU STOP ------*/}
            {/*------ THIS IS WHERE YOU STOP ------*/}
            {/*------ THIS IS WHERE YOU STOP ------*/}
