      ...
      <div className='ittechnologies'>
        <div className="ittechnologies-content">
          ...
          <div className='ittechnologies-machlearn'>
            ...
            <p>American Express operationally have over a trillion transactions to analyse. To safeguard their customer cards they rely on system algorithms to analyse transactional data and detect fraud in real time. ​(Mar, 2019)​</p>
            ...
            <p>Further to image recognition, there is video surveillance machine learning technology. In addition to facial feature detection, video surveillance data also includes audio. The algorithms can look at the presence of humans in particular images and track movements and to then learn from the movements and identify humans. </p>
            <p>Machine Learning technology is currently used in online map services like google maps. Machine learning algorithms explore traffic and road data and have learnt to compare route guidance against traffic congestion and can provide the user with different route navigation options.</p> 
            ...
            <p>Algorithms of medical data in medical research has the potential to provide greater insights to doctors and provide the information much quicker. </p> 
            <p>By transforming industries including health care, automotive, and manufacturing for example it has the potential to affect everyone. It will improve the services and quality of products and help with earlier diagnosis of disease in health care.</p>
            ...
            <p>We will see improvements with our daily lives as the technology in machine learning evolves.</p>
            ...
            <p>The speed of machine learning technology in the military space is the area of change that may be considered most concerning. Most large armed forces are already delivering on unmanned objects of war and weaponised drones and vessels. The outcome of which could lead to more casualties of war or in the hypothetical sensationalised case of the premise described in the movies starting with Terminator 1 ​(The Terminator, 1984)​, could machine learning evolve to a point of removing human decision making from military devices? Seems unlikely however the rapid rise in development and research in this area has immense potential and concern.</p>
            <br></br>
            <br></br>
            <h2>References</h2>
            <ol>
              <li>Great Learning Team, 2022. What is Machine Learning? - Types, Applications, and more. [Online]  
              Available at: https://www.mygreatlearning.com/blog/what-is-machine-learning/ 
              <br></br>[Accessed 3 January 2023].</li>
              <li>Mar, B., 2019. 27 Incredible Examples Of AI And Machine Learning In Practice. [Online]  
              Available at: https://www.forbes.com/sites/bernardmarr/2018/04/30/27-incredible-examples-of-ai-and-machine-learning-in-practice/?sh=221b87b17502 
              <br></br>[Accessed 3 January 2023]</li>
              <li>Marktechpost, 2022. Top Emerging Machine Learning Trends For 2022. [Online]  
              Available at: https://www.marktechpost.com/2022/03/02/top-emerging-machine-learning-trends-for-2022/ 
              <br></br>[Accessed 3 January 2023].</li>
              <li>Omdena, 2022. Top 10 Machine Learning Examples in Real Life (Which Make the World a Better Place). [Online]  
              Available at: https://omdena.com/blog/machine-learning-examples/ 
              <br></br>[Accessed 3 January 2023]</li>
              <li>Simplilearn, 2022. 6 Emerging AI and Machine Learning Trends to Watch in 2023. [Online]  
              Available at: https://www.simplilearn.com/artificial-intelligence-ai-and-machine-learning-trends-article 
              <br></br>[Accessed 3 January 2023].</li>
              <li>The Economist, 2022. Ukrainian ingenuity is ushering in a new form of warfare at sea. [Online]  
              Available at: https://www.economist.com/science-and-technology/2022/12/07/ukrainian-ingenuity-is-ushering-in-a-new-form-of-warfare-at-sea 
              <br></br>[Accessed 4 January 202]</li>
            </ol>
          </div>
          <div className='ittechnologies-autovec'>
            <h2>Autonomous Vehicles</h2>
            <p>Since 1939 the race has been on for the first company to create a functioning autonomous vehicle, GM created the very first self-driving vehicle, which was guided by radio-controlled, electromagnetic fields, generated with magnetized metal spikes embedded within the length of the roadway. However, this concept was not yet fully operational until almost 20 years later in 1958, the vehicle’s front end was fitted with sensors that could detect the flowing current through a wire planted in the road. Fast-forward 6 decades and the state-of-the-art autonomous vehicle Is much more capable than simply traversing the length of wire-embedded roadways, among the 25.14-billion-dollar worldwide market value for autonomous vehicles, as of today, Tesla has created the most advanced auto vehicle with the Model S. Today’s technologies have led to the making of a vehicle built from the ground up being only powered by electricity,  with a range of 396 miles to a full charge and the ability to go from 0 to 96 km per hour, the Tesla Model S marks the highest reaching point for current autonomous vehicle creation. Fully autonomous vehicles have the capability to perform not only basic driving tasks such as; fully driver-less driving, breaking and parking, they can also perform much more intense evasive maneuverers and lifesaving driving techniques with the help of; sensors, actuators, complex algorithms, machine learning systems and powerful processors. While speed and acceleration are key talking points when discussing electric, self-driving vehicles, the large amount of safety benefits associated with driverless- cars are far more important. The general agreement amongst Australian and international experts are that 90% of all accidents could be eliminated through advanced driverless vehicle technology. With the large array of sensors imbedded in driverless vehicles, it is virtually impossible for any minor incidents to occur, while also predicting any collisions coming up ahead that the human brain is simply not capable of doing. Human error is one of the leading causes of practically all traffic accidents; by removing the risk of delayed reactions or other human errors, I.e., falling asleep at the wheel, the chance of human contributed accidents is greatly reduced. Globally in 2019, there was an estimated 31.4 million autonomous vehicles on the road, and it was shown to incline to a total of 43.57 million by the end of 2022 (Titlemax, 2022), this is thanks to the continuously proven benefits of owning an AI vehicle but mainly because most of these vehicles run on electric power which drastically saves customer’s money over time. Within the foreseeable future, alongside multiple companies, such as Apple, planning to roll out their own AI vehicles, the autonomous vehicles of the future will have a heavier level of reliability on camera-based technology, this focus comes after the use of; multiple signals, including cameras, lidar, radar and digital maps has been considered outdated by multiple scientists and AI vehicle companies. The hopes for camera input only comes with the continued evidence that with enough inputted data and computing power, alongside the right deep learning architecture, artificial intelligent systems will have the capability to do things we thought were previously impossible (ADAS and Autonomous Vehicles, 2022). The leaders in the camera only movement are Tesla, spokespersons from Tesla have spoken out about how the company is using neural networks and camera input to estimate depth, velocity and required acceleration. Tesla is also the only company that has full power over the entire hardware and software stacks, they use these stacks to continue to teach and train their deep learning modules, which when added to camera only technology will only push them further in the evolution of driverless vehicles(Tesla, 2020). Whatever the future has planned for AI vehicles, it isn’t a stretch to say that Tesla will still be leading the pack.</p><br></br>

            <p>With the greater number of autonomous vehicles on the road, there will no doubt be a large amount of positive and negative impacts associated with this, these impacts greatly affect the areas of; Livability, economic and environmental. Autonomous vehicles greatly account for a decline of noise pollution in many local and urban areas, by removing regular petroleum-based engines, the benefits are also astronomical to countless varieties of wildlife (TMR QLD, 2021). Without the need for an exhaust system in place, autonomous/electric vehicles create zero exhaust commissions, these emissions include; Carbon monoxide, hydrocarbons, nitrogen oxides, volatile organic compounds and sulfur dioxide and when mixed with sunlight and warm temperatures, form a ground-level ozone (ANZ Driverless Vehicle Initiative, 2022). However, with the removal of engines from most autonomous vehicles being mostly positive, this does also bring it’s share of negative impacts, in most countries, renewable energy is used to charge electric engines, however, in several US countries, for example, most of their energy is still being generated by coal plants, which in turn, makes driving AI vehicles much less sustainable than those relying on renewable energy (EARTH.ORG, 2022). Recent human rights concerns have sparked following the need for cobalt batteries in AI vehicles, these concerns stem for the fact that the largest cobalt mines are within The Democratic Republic of Congo, these mines use artisanal miners and expose them to severally dangerous conditions. With approximately 200,000 Artisanal miners working in the Congo alone and without any form of safety protection, it is estimated that up to 2,000 of these illegal miners are dying every year without being recorded(CNBC, 2021). Looking on the lighter side, without the need for full, able-bodied drivers behind the wheel, autonomous vehicles give disabled drivers the chance of easily accessible mobility once again with the help of our ever-evolving feats of technology. A commonly heard about fear is that thousands of workers will be kicked out of their jobs due to the redundancy levels associated with the lack of petrol vehicles, it is also fact that with the autonomous vehicle industry growing faster than ever before, thousands of more jobs and completely new career opportunities will become available to both experienced and non-experienced workers within the automobile industry. With new jobs also brings forward the need for newer technologies, Vehicle-to-Vehicle technology communication is the potential next stage in building the technology required for AI vehicles. This enables connected vehicles to exchange information through a wireless network about factors such as; position, speed, direction, braking and acceleration.</p><br></br>
