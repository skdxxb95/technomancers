...
Damian - Cyber Security Analyst. (Specialisation of ICT Security) (Australian Government - Jobs and Skills, 2022) (Australian Government, 2021)
        ...
        <br></br>       
          ...
          <p>
           ...
           <b>Brodie:</b><br /><q>When entering this degree, I was hoping to find the skills required to become a .NET developer, as I found that to be the highest paid and most frequently desired job. After having read the Burning Glass data, my initial theory has been confirmed, seeing that .NET Developer was the third highest in Top Titles, over 1370 listings for .NET programming as well as 1643 listings for C# programming in Top IT Skills, and communication and problem solving being the two most highly desirable skills in Skills in Greatest Demand.</q><br /><br />
